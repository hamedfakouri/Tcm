...
namespace Tcm.Persistence.Ef.Migrations
{
    ...
    [Migration("20190308154048_addEducationYear")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tcm.Domain.Model.EducationYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tcm.Domain.IdentityModel.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "0c96633b-0a08-4af7-9536-051f33c2a0f7",
                            Name = "Manager",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "21ecb08d-44af-46c3-8627-646a50a24b9b",
                            Name = "Student",
            ...
            modelBuilder.Entity("Tcm.Domain.Model.ClassRoom", b =>
                {
                    b.HasOne("Tcm.Domain.Model.EducationYear", "EducationYear")
                        .WithMany("classRooms")
